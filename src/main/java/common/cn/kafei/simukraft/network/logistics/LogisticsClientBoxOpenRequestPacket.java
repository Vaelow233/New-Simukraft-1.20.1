...
public record LogisticsClientBoxOpenRequestPacket(BlockPos pos) {
    public static void encode(LogisticsClientBoxOpenRequestPacket packet, FriendlyByteBuf buffer) {
        buffer.writeBlockPos(packet.pos());
    }

    public static LogisticsClientBoxOpenRequestPacket decode(FriendlyByteBuf buffer) {
        return new LogisticsClientBoxOpenRequestPacket(buffer.readBlockPos());
    }

    public static void handle(LogisticsClientBoxOpenRequestPacket packet, Supplier<NetworkEvent.Context> context) {
